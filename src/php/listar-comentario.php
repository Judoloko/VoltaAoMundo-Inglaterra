    ...
    <table border="2" class=" table table-striped table-sm  table-dark  w-100 p-3">
      ...
      <?php foreach ($listaComentarios as $linha): ?>
        <tr>
          ...
          <td>
            <?php echo $linha['status_comentario'] ?>
          </td>
          <td>
            <form action="alterar_status-comentario.php" method="post">
              <input hidden="hidden" name="id" value="<?php echo $linha['id'] ?>" />
              <input hidden="hidden" name="status_comentario" value="<?php echo $linha['status_comentario'] ?>" />
              <button type="submit">
                Alterar Status
              </button>
            </form>
